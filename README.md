...
<h2>Evaluation</h2>
As it can be observed,  the best model seems to be Logistic Regression as shown, overall, it was thought that Logistic Regression model may be considered the winner for classifying the dataset analyzed in this study. The KNeighborsClassifier and Decision Tree are fairly decent as well. 
